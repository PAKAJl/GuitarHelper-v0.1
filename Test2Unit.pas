...
uses
  ...
  Dialogs, StdCtrls, pngextra, pngimage, ExtCtrls;
...
var
  Test2: TTest2;c1,c2,c3,c4,c5,c6,c7,c8,c9:boolean;
...
procedure TTest2.v1Click(Sender: TObject);
begin
  if c1 = false then
    begin
...
procedure TTest2.v2Click(Sender: TObject);
begin
 if c2 = false then
    begin
...
procedure TTest2.v3Click(Sender: TObject);
begin
 if c3 = false then
    begin
...
procedure TTest2.v4Click(Sender: TObject);
begin
 if c4 = false then
    begin
...
procedure TTest2.v5Click(Sender: TObject);
begin
 if c5 = false then
    begin
...
procedure TTest2.v6Click(Sender: TObject);
begin
 if c6 = false then
    begin
...
procedure TTest2.v7Click(Sender: TObject);
begin
 if c7 = false then
    begin
...
procedure TTest2.v8Click(Sender: TObject);
begin
 if c8 = false then
    begin
...
procedure TTest2.v9Click(Sender: TObject);
begin
 if c9 = false then
    begin
...
procedure TTest2.PNGButton1Click(Sender: TObject);
begin
  if (c3 = true)and(c5 = true)and(c7 = true) then
    begin
    showMessage('Тест пройден');
      DataModule1.ADOQuery1.SQL.clear;
      datamodule1.ADOQuery1.SQL.Add('UPDATE Users Set Test2 = true WHERE Login='+#39+ProfileForm.Edit3.Text+#39);
